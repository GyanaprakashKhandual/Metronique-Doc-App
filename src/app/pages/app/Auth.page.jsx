...
import { Mail, Lock, User, Eye, EyeOff, ArrowLeft, CheckCircle2, AlertCircle, ArrowRight } from 'lucide-react';
...
export default function Auth() {
  ...
  const handleOAuth = (provider) => {
    window.location.href = `http://localhost:5000/api/v1/users/auth/${provider}`;
  };
